...
import { IS_AGON_DEPLOYMENT, PRODUCT_TITLE } from "@/lib/product";
...
export const alt = PRODUCT_TITLE;
...
const WORDMARK = IS_AGON_DEPLOYMENT ? "AGON" : "ARCRUN";
const DOMAIN = IS_AGON_DEPLOYMENT ? "agon.surf" : "arcrun.xyz";
