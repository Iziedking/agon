...
import { BnbMarketContent, BnbAgentContent, BnbActivityContent, BnbPublishContent, BnbPlaygroundContent, bnbHref } from "@/shared/MarketContent";
...
function Content({ view }: { view: "market" | "detail" | "activity" | "publish" | "playground" }) {
...
export function LiveMarket({ view = "market" }: { view?: "market" | "detail" | "activity" | "publish" | "playground" }) { return <Suspense fallback={<div className="min-h-screen bg-canvas"/>}><Content view={view}/></Suspense>; }
