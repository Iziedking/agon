...
function Content({ view }: { view: "market" | "detail" | "activity" | "compare" | "publish" | "playground" }) {
  ...
  return <div className="min-h-screen bg-canvas text-ink">
    <header className="border-b border-[color:var(--hairline)]"><div className="mx-auto flex max-w-[1600px] flex-wrap items-center justify-between gap-3 px-4 py-3 sm:px-6">
      ...
      <nav aria-label="Main navigation" className="flex gap-6 font-mono text-[11px] uppercase tracking-widest"><a href={bnbHref(chainId, "/market")}>MARKET</a><a href={bnbHref(chainId, "/market/activity")}>ACTIVITY</a><a href={bnbHref(chainId, "/market/new")}>LIST AN AGENT</a></nav>
